...
SLI and Ocean Optics ASCII now have experimental readers for their first
high-value subsets.
...
- Ocean Optics ASCII; experimental for SpectraSuite, OceanView, Jaz, CRAIC and two-column CSV exports;
