//! extendr-api bridge for `nirs4all-formats`.
//!
...
/// @export
#[extendr]
fn nirs4allformats_native_read(
    path: &str,
...
/// @export
#[extendr]
fn nirs4allformats_native_read_bytes(
    name: &str,
    bytes: &[u8],
    rows: Nullable<Integers>,
    cols: Nullable<Integers>,
...
/// @export
#[extendr]
fn nirs4allformats_native_read_with_sidecars(
    name: &str,
    bytes: &[u8],
    sidecars: List,
    rows: Nullable<Integers>,
...
/// @export
#[extendr]
fn nirs4allformats_native_walk(
    path: &str,
...
extendr_module! {
    mod nirs4allformats_r;
    fn nirs4allformats_native_probe;
    fn nirs4allformats_native_read;
    fn nirs4allformats_native_read_bytes;
    fn nirs4allformats_native_read_with_sidecars;
    fn nirs4allformats_native_walk;
