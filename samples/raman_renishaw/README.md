...
| File | Mode | Size |
|---|---|---|
| `renishaw_test_spectrum.wdf` | Single point spectrum | 244 B |
| `renishaw_test_linescan.wdf` | Linescan | 324 B |
| `renishaw_test_map.wdf` | XY map | 328 B |
| `renishaw_test_map2.wdf` | XY map (variant) | 2.0 KB |
| `renishaw_test_timeseries.wdf` | Time series | 264 B |
| `renishaw_test_zscan.wdf` | Z scan (depth) | 232 B |
| `renishaw_test_streamline.wdf` | Streamline mapping | 3.6 KB |
| `renishaw_test_focustrack.wdf` | Focus tracking | 268 B |
| `renishaw_test_focustrack_invariant.wdf` | Focus tracking (invariant) | 120 B |
| `renishaw_test_exptime10_acc1.wdf` | Variable exposure time | 256 B |
| `renishaw_test_undefined.wdf` | Undefined / minimal | 16 B |
| `interrupted_acquisition.wdf` | Interrupted scan (negative test) | 296 B |
