...
| `scio_forensic_P_avg.xlsx` | 212 KB | [`Figshare 21252300`](https://doi.org/10.21942/uva.21252300) (`P_Avg_Scio.xlsx`) | **CC-BY-4.0** (UvA, Kranenburg et al. 2022) | Real Consumer Physics **SCiO** (740-1070 nm) averaged-per-sample export of 175 phenacetin/cocaine forensic samples — single sheet, `axis: wave` row + wavelength columns + per-sample rows. Smallest real-vendor Excel fixture currently shipping; exercises the "wide-spectra-with-axis-row" Excel layout that miniaturised handheld vendors export. |
