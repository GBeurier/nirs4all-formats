...
| `synthetic_nirs_autoincrement.animl` | ~2 KB | Generated locally | CC-0 | Synthetic single-spectrum AnIML with a uniform wavelength axis encoded as `AutoIncrementedValueSet`. |
