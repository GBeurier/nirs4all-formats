...
| File | Notes |
|---|---|
| `synthetic_unispec.SPT` | Synthetic UniSpec SC export with header metadata + `Wavelength,DN_white,DN_target,Reflectance` columns. CC-0. |
| `synthetic_unispec_dc.SPU` | Synthetic UniSpec DC dual-channel export with `Wavelength,Channel_A_DN,Channel_B_DN,Reflectance` columns. CC-0. |
